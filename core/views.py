...
from core.serializers import (
    ...
    UserRegistrationRequestSerializer, UserRegistrationResponseSerializer,
)
...
class RoomListAPIView(generics.ListAPIView):
    ...
    filter_backends = [filters.OrderingFilter, IsAvailableFilterBackend, DjangoFilterBackend]
